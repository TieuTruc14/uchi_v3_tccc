        ...
        <form class="form-horizontal" action="/template/privy-synch" id="search-frm" method="get" name="myForm">
            ...
            <div class="col-md-12">
                ...
                <table class="table" style="margin-bottom:0%">
                    ...
                    <c:if test="${privyTemplateList.size() > 0}">
                        <c:forEach items="${privyTemplateList}" var="item">
                            <tr>
                                ...
                                <td class="border-table align-giua" style="min-width: 150px"><a href="<%=request.getContextPath()%>/template/privy/edit/${item.id}" class="btn btn-primary btn-xs">Cập nhật</a> / <a href="<%=request.getContextPath()%>/template/privy/detail/${item.id}" class="btn btn-info btn-xs">Chi tiết</a> / <a class="btn btn-danger btn-xs" data-toggle="modal" data-target="#myModal${item.id}">Xóa</a></td>
