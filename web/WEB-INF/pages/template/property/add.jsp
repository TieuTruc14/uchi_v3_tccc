    ...
    <div class="panel-group" id="accordion">
        <form class="form-horizontal" action="${addUrl}" id="formSubmit" method="post" >
            ...
            <div class="panel panel-default" id="panel1">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-10">
                            <input type="text" class="form-control " name="name" value="${propertyTemplate.name}">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-10">
                            <select name="type" class="form-control truong-selectbox-padding">
                                ...
                                <option value="01" ${propertyTemplate.getType().equals("01") ?"selected":""}>Nhà đất</option>
                                <option value="02" ${propertyTemplate.getType().equals("02") ?"selected":""}>Xe cộ</option>
                                <option value="99" ${propertyTemplate.getType().equals("99") ?"selected":""}>Tài sản khác</option>
                            </select>
                            <div class="error_tooltip">${list_msg.type}</div>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-md-2 control-label required label-bam-trai">Mô tả</label>
                        <div class="col-md-10">
                            <input type="text" class="form-control " name="description" value="${propertyTemplate.description}">
                            <div class="error_tooltip">${list_msg.description}</div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea hidden  class="col-md-12"  id="giatriKindHtml"  name="html"  rows="4" value="${propertyTemplate.html}" ></textarea>
            ...
            <div class="form-group" style="text-align: center;margin:20px 0px;">
                ...
                <a class="btn btn-default"  style="min-width:130px;" href="/template/property/list">Hủy bỏ</a>
            </div>
        </form>
    </div>
</div>
