            ...
            <div class="panel panel-default" id="panel1">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-10">
                            <input type="text" class="form-control ${list_msg.msgName != null ?"error_input":""}" name="name" value="${propertyTemplate.name}">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-10">
                            <select name="type" class="form-control truong-selectbox-padding">
                                ...
                                <option value="99" ${propertyTemplate.type.equals("99") ?"selected":""}>Tài sản khác</option>
                            </select>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-10">
                            <input type="text" class="form-control  ${list_msg.msgDescription != null ?"error_input":""}" name="description" value="${propertyTemplate.description}">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-10">
                            <label class="checkbox-inline"><input type="checkbox"  name="disable" style="margin-top:0px" ${propertyTemplate.disable== true ?"checked":""} >Ngừng hoạt động</label>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <textarea hidden  class="col-md-12"  id="giatriKindHtml"  name="html"  rows="4" value="${item.html}" ></textarea>
                    </div>
                </div>
            </div>
