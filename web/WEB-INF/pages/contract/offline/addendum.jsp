                    ...
                    <div class="row truong-inline-field">
                        <div class="form-group">
                            <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    <select class="selectpicker select2 col-md-12 no-padding" ng-model="contractKind.contract_kind_code" ng-change="myFunc(contractKind.contract_kind_code)" disabled
                    ...
                    <div class="row truong-inline-field">
                        <div class="form-group">
                            <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    <select  class="selectpicker select2 col-md-12 no-padding" ng-model="contract.contract_template_id" disabled
                    ...
                    <div class="tree well" >
                        <ul>
                            <li ng-repeat="(itemIndex,item) in privys.privy track by $index">
                                ...
                                <a class="btn btn-xs btn-success " ng-click="addPerson($index)" ><i class="fa fa-plus"></i>Thêm cá nhân</a>
                                <a class="btn btn-xs btn-success " ng-click="addOrg($index)" ><i class="fa fa-plus"></i>Thêm tổ chức</a>
                                <a class="btn btn-xs btn-danger " ng-click="removePrivy($index)" ><i class="fa fa-plus"></i>Xóa {{item.name}}</a>
                                <ul>
                                    <li ng-repeat="user in item.persons track by $index">
                                            ...
                                            </span> <a class="btn btn-xs btn-danger " ng-click="removePerson(itemIndex,$index)" ><i class="fa fa-plus"></i>Xóa</a>
                                    </li>
                                </ul>
                            </li>
                        </ul>
                                    ...
                                    <li ng-repeat="item in listProperty.properties track by $index">
                                        <div class="treeChild">
                                            ...
                                            <div class="col-md-7 col-md-offset-2">
                                                <select  ng-model="item.type_view" class="form-control" ng-change="changTypeViewProperty($index,item.type_view)" >
