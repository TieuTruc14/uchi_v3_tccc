...
<script src="<%=request.getContextPath()%>/static/js/contract/offline/contract.cancel.js" type="text/javascript"></script>
        ...
        <div class="form-horizontal"  method="post">
                ...
                <div class="panel-body">
                    ...
                    <div class="row truong-inline-field">
                        <div class="form-group">
                            ...
                            <div class="col-md-3">
                                <input type="text" class="form-control" name="contract.received_date"  ng-model="contract.received_date" id="drafterDate" maxlength="10" disabled="true">
                            </div>

                            <label class="col-md-3 control-label ">Ngày công chứng</label>
                            <div class="col-md-3 ">
                                <input type="text" class="form-control" name="contract.notary_date" ng-model="contract.notary_date" id="notaryDate" maxlength="10" disabled="true">
                            </div>
                                    ...
                                    <section class="panel panel-default" ng-repeat="item1 in item.persons track by $index">
                                        ...
                                        <div class="panel-body"  ng-switch on="item1.template==2">
                                            <div ng-switch-when=true>
                                                ...
                                                <div class="form-group">
                                                    <label class="col-sm-3 control-label label-bam-trai">Họ tên người đại diện</label>
                                                    <div class="col-sm-9"  >
                                            ...
                                            <div class="form-group" >
                                                <label class="col-sm-3 control-label label-bam-trai">CMT/Hộ chiếu</label>
                                                <div class="col-sm-9 ">
                                                    <input type="text" class="form-control" ng-model="item1.passport" disabled />
                                                </div>
                                            </div>
                                            <div class="form-group">
            ...
            <div class="panel-body">
                <div class="list-buttons" style="text-align: center;">
                    ...
                    %>
                    <a href="<%=request.getContextPath()%>/contract/temporary/list" ng-show="checkOnline" class="btn btn-s-md btn-default">Về danh sách</a>
                    <a href="<%=request.getContextPath()%>/contract/list" ng-show="!checkOnline" class="btn btn-s-md btn-default">Quay về danh sách</a>
                </div>
            </div>
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-success" data-dismiss="modal" ng-click="cancelContract()">Đồng ý</button>
