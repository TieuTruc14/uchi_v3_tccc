...
<%--
    Báo cáo theo hợp đồng bổ sung
--%>
<spring:url value="/report/contract-additional" var="reportUrl"/>

<div id="menu-map">
    <a href="#menu-toggle" id="menu-toggle"><img src="<%=request.getContextPath()%>/static/image/menu-icon.png"></a>
    <span id="web-map">Báo cáo theo hợp đồng bổ sung</span>
</div>
<div class="truong-form-chinhds panel-group">
    <form class="form-horizontal" id="search-frm" action="${reportUrl}" method="get">
        <input type="hidden" name="page" id="page" value="${contractAdditionalWrapper.page}">
        <input type="hidden" name="totalPage" id="totalPage" value="${contractAdditionalWrapper.totalPage}">
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            ...
                            <select class="form-control truong-selectbox-padding" name="timeType" id="timeType">
                                <option value="01" ${contractAdditionalWrapper.timeType.equals('01')?"selected":""}>Trong ngày hôm nay</option>
                                <option value="02" ${contractAdditionalWrapper.timeType.equals('02')?"selected":""}>Trong tuần này</option>
                                <option value="03" ${contractAdditionalWrapper.timeType.equals('03')?"selected":""}>Trong tháng này</option>
                                <option value="04" ${contractAdditionalWrapper.timeType.equals('04')?"selected":""}>Trong năm nay</option>
                                <option value="05" ${contractAdditionalWrapper.timeType.equals('05')?"selected":""}>Trong khoảng thời gian</option>
                            </select>

                        </div>
                        <div class="col-md-9">
                            <div class="row">
                                <div ${contractAdditionalWrapper.timeType.equals('05')?"":"style='display: none;'"} id="dateTimeFilter">
                                    <div class="col-md-9">
                                        <div class="row">
                                            <label class="col-md-3 control-label  label-bam-phai">Từ ngày</label>
                                            <div class="col-md-3">
                                                <input type="text" value="${contractAdditionalWrapper.fromDate}" class="form-control date-time" name="fromDate" id="fromDate" >
                                            ...
                                            <div class="col-md-3">
                                                <input type="text" value="${contractAdditionalWrapper.toDate}" class="form-control date-time" name="toDate" id="toDate">
    ...
    <div class="panel-body truong-margin-footer0px">
        ...
        <table class="table" style="margin-bottom:0%">
            ...
            <tr class="border-table">
                ...
                <th class=" ann-title border-table table-giua truong-rstable-widthper15">Giấy tờ cần bổ sung</th>
            ...
            <c:if test="${contractAdditionalWrapper.total != 0}">
                ...
                <c:forEach items="${contractAdditionalWrapper.contractAdditionals}" var="item">

                    <tr>
                        <td class="border-table truong-text-verticel">${item.drafter_family_name} ${item.first_name}</td>
                        ...
                        <td class="border-table truong-text-verticel">${item.addition_description}</td>
                ...
                <tr class="table-tr-xam">
                    <th colspan="7"><div class="truong-padding-foot-table">Tổng số <span class="truong-text-colorred">${contractAdditionalWrapper.total}</span> dữ
                        liệu</div>
                        <div class="align-phai">
                            <c:if test="${contractAdditionalWrapper.page==1}">
                                <img
                            ...
                            <c:if test="${contractAdditionalWrapper.page!=1}">
                                ...
                                ${contractAdditionalWrapper.page}
                            trên ${contractAdditionalWrapper.totalPage}
                            <c:if test="${contractAdditionalWrapper.page==contractAdditionalWrapper.totalPage}">
                                <img
                                        class="truong-pagging-icon"
