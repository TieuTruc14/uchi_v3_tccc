        ...
        <div class="form-horizontal"  method="post">
                        ...
                        <div class="form-group">
                            <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select class="selectpicker select2 col-md-12 no-padding" ng-model="contractKind.contract_kind_code" name="contractKind" ng-change="myFunc(contractKind.contract_kind_code)" required disabled
                        ...
                        <div class="form-group">
                            <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select class="selectpicker select2 col-md-12 no-padding" ng-model="contract.contract_template_id" name="template" ng-change="changeTemplate(contract.contract_template_id)" required disabled
                    ...
                    <div class="row truong-inline-field">
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="col-md-6 ">
                                    <input type="text" class="form-control" name="notary_date"  ng-model="contract.notary_date" id="notaryDate" minlength="10" maxlength="10" onkeypress="return restrictCharacters(this, event, forDate);" required  />
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-8" ng-switch on="contract.file_name.length>0">
                                            <div ng-switch-when="true">
                                                ...
                                                <a style="margin-left:10px;" class="btn btn-danger btn-xs"  data-toggle="modal"  data-target="#removeFile" >Gỡ bỏ</a>
                                            </div>
                                            <div ng-switch-default>
            ...
            <div class="panel-body" style="margin-bottom:30px; text-align:center;">
                <div class="list-buttons" style="text-align: center;">
                    ...
                    %>
                    <a ng-dissable="checkLoad" data-toggle="modal"  data-target="#editContract"  class="btn btn-s-md btn-success">Lưu</a>
                    <%
                        }
    ...
    <div class="modal fade" id="removeFile" role="dialog">
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-danger" data-dismiss="modal" ng-click="removeFile()">Xóa</button>
                    <button type="button" class="btn btn-default" data-dismiss="modal">Hủy bỏ</button>
                </div>
            </div>
    ...
    <div class="modal fade" id="editContract" role="dialog">
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-success" data-dismiss="modal" ng-click="editTemporary()">Đồng ý</button>
                    <button type="button" class="btn btn-default" data-dismiss="modal">Hủy bỏ</button>
                </div>
            </div>
        </div>
