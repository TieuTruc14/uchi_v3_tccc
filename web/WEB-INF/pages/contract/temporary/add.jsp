    ...
    <div class="panel-group" id="accordion">
                    ...
                    <div class="row truong-inline-field">
                        <div class="form-group">
                            <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    <select ng-model="contract.contract_template_id" name="template" class="selectpicker select2 col-md-12 no-padding" ng-change="changeTemplate(contract.contract_template_id)" required>
                                        <option value="">--Chọn--</option>
                    ...
                    <div class="row truong-inline-field">
                        <div class="form-group">
                            <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    <input type="text" class="form-control" name="received_date"  ng-model="contract.received_date" id="fromDate" minlength="10" maxlength="10" onkeypress="return restrictCharacters(this, event, forDate);" required />
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="col-md-6 ">
                                    <input type="text" class="form-control" name="notary_date" ng-model="contract.notary_date" id="toDate" ng-change="changeDateNotary(contract.notary_date)" minlength="10" maxlength="10" onkeypress="return restrictCharacters(this, event, forDate);"  required />
        ...
        <%--<div class="panel panel-default">--%>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-8">
                                                <select ng-model="contract.bank_code" class="selectpicker select2 col-md-12 no-padding">
                                                    <option  value="" >--Chọn--</option>
                                                    <option  ng-repeat="item in banks" value="{{item.code}}" >{{item.name}}</option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="form-group">
            ...
            <div class="panel-body" style="text-align: center;">
                ...
                %>
                <a  data-toggle="modal"  data-target="#addContract" ng-dissable="checkLoad" class="btn btn-s-md btn-success">Lưu</a>
                <%
                    }
                %>
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>Bạn chưa chọn công chứng viên, có muốn lưu hợp đồng dạng đang chỉnh sửa không? </p>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-success" data-dismiss="modal" ng-click="addContract()">Đồng ý</button>
